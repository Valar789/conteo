      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-zinc-200 dark:border-zinc-700">
            <th className="py-3 px-4 text-left font-medium text-sm">Código</th>
            <th className="py-3 px-4 text-left font-medium text-sm">Nombre</th>
            <th className="py-3 px-4 text-left font-medium text-sm">Descripción</th>
            <th className="py-3 px-4 text-center font-medium text-sm">Cantidad</th>
            <th className="py-3 px-4 text-left font-medium text-sm">Fecha de creación</th>
            <th className="py-3 px-4 text-center font-medium text-sm">Acciones</th>
          </tr>
        </thead>
        <tbody>
          {[...Array(5)].map((_, index) => (
